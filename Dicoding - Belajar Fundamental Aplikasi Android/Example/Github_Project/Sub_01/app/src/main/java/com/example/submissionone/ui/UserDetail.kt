...
import com.example.submissionone.adapter.PagerAdapter
import com.example.submissionone.data.database.entity.EntityUser
import com.example.submissionone.databinding.ActivityDetailUserBinding
import com.example.submissionone.model.DetailUserModel
...
class UserDetail : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        detailViewModel.getDataByUsername(username).observe(this) {
            ...
            val favoriteUser = EntityUser(username, avatar, urlHtml)
            if (it.isEmpty()) {
